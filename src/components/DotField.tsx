...
const DotField = memo(({
  ...
  sparkle = false,
  waveAmplitude = 0,
  gradientFrom = 'rgba(249, 115, 22, 0.25)', // Orange accent color for AIMS theme
  gradientTo = 'rgba(245, 158, 11, 0.12)', // Amber accent
  glowColor = '#1e110a', // Dark warm ambient orange-brown glow
  ...rest
}: DotFieldProps) => {
